...
From the imaginative mind of debut author Charlie N. Holmberg, The Paper Magician is an extraordinary adventure both dark and whimsical that will delight readers of all ages.', '47North');
...
In this Deluxe Spellbook Edition you''ll find: Spells created by You and other keepers of secrets-poems, spells and meditations contributed by fans of this popular series. Extras also include an interview with the author.', 'Llewellyn Publications')
...
But there’s a new, more urgent menace in the small town. One by one, teenage girls are disappearing. Frantic for her daughters’ safety, Sarah feels her veneer cracking and the house’s walls closing in on her again. Somewhere deep in her memory is the key to a very real and terrifying danger. And only by confronting her worst fears can she stop the nightmare roaring back to life once more....', 'Kensington')
...
Labeled a parable, an allegory, a myth, a morality tale, a parody, a political treatise, even a vision of the apocalypse, Lord of the Flies has established itself as a true classic.', 'Perigee Books')
...
Laborers in California''s dusty vegetable fields, they hustle work when they can, living a hand-to-mouth existence. For George and Lennie have a plan: to own an acre of land and a shack they can call their own. When they land jobs on a ranch in the Salinas Valley, the fulfillment of their dream seems to be within their grasp. But even George cannot guard Lennie from the provocations of a flirtatious woman, nor predict the consequences of Lennie''s unswerving obedience to the things George taught him.', 'Penguin Books')
...
The Great Gatsby is one of the great classics of twentieth-century literature.', 'Scribner')
...
In this empowering book, Gavin de Becker, the man Oprah Winfrey calls the nation''s leading expert on violent behavior, shows you how to spot even subtle signs of danger—before it''s too late. Shattering the myth that most violent acts are unpredictable, de Becker, whose clients include top Hollywood stars and government agencies, offers specific ways to protect yourself and those you love, including...how to act when approached by a stranger...when you should fear someone close to you...what to do if you are being stalked...how to uncover the source of anonymous threats or phone calls...the biggest mistake you can make with a threatening person...and more. Learn to spot the danger signals others miss. It might just save your life.', 'Dell')
...
Remember. Survive. Run.', 'Delacorte Press');
...
Set over the course of one school year, this is the story of two star-crossed sixteen-year-olds smart enough to know that first love almost never lasts, but brave and desperate enough to try.', 'St. Martin''s Griffin');
...
Introducing Cormoran Strike, this is the acclaimed first crime novel by J.K. Rowling, writing under the pseudonym Robert Galbraith.', 'Mulholland Books');
...
Insightful, bold, irreverent, and raw, The Fault in Our Stars is award-winning author John Green''s most ambitious and heartbreaking work yet, brilliantly exploring the funny, thrilling, and tragic business of being alive and in love.', 'Dutton Books');
...
Tina Fey reveals all, and proves what we''ve all suspected: you''re no one until someone calls you bossy.', 'Hachette Audio');
...
Intense, hilarious, provocative, and moving, A Long Way Down is a novel about suicide that is, surprisingly, full of life. ', 'Riverhead Trade');
...
Tris''s initiation day should have been marked by celebration and victory with her chosen faction; instead, the day ended with unspeakable horrors. War now looms as conflict between the factions and their ideologies grows. And in times of war, sides must be chosen, secrets will emerge, and choices will become even more irrevocable—and even more powerful. Transformed by her own decisions but also by haunting grief and guilt, radical new discoveries, and shifting relationships, Tris must fully embrace her Divergence, even if she does not know what she may lose by doing so.', 'HarperCollins Children''s Books');
...
But Tris''s new reality is even more alarming than the one she left behind. Old discoveries are quickly rendered meaningless. Explosive new truths change the hearts of those she loves. And once again, Tris must battle to comprehend the complexities of human nature—and of herself—while facing impossible choices about courage, allegiance, sacrifice, and love. ', 'HarperCollins Children''s Books');
...
In Is Everyone Hanging Out Without Me?, Mindy invites readers on a tour of her life and her unscientific observations on romance, friendship, and Hollywood, with several conveniently placed stopping points for you to run errands and make phone calls. Mindy Kaling really is just a Girl Next Door—not so much literally anywhere in the continental United States, but definitely if you live in India or Sri Lanka.', 'Crown Archetype');
...
And the empty seat left by Barry on the parish council soon becomes the catalyst for the biggest war the town has yet seen. Who will triumph in an election fraught with passion, duplicity and unexpected revelations?', 'Little, Brown and Company');
...
Hurled back in time by forces she cannot understand, Claire is catapulted into the intrigues of lairds and spies that may threaten her life, and shatter her heart. For here James Fraser, a gallant young Scots warrior, shows her a love so absolute that Claire becomes a woman torn between fidelity and desire—and between two vastly different men in two irreconcilable lives.', 'Deli Publishing Company');
